...
<body>
	...
	<div class=templetJ_contents>
		...
		<div class=templetJ_overview>
			...
			<p class= templetJ_name>Overview</p>
			
			<p class= templetJ_subtitle>온라인 향수시장의 성장을 위한 미디어 인터랙션 프로모션</p>
			<h1 class= templetJ_title>Forest</h1>
		...
		<div class=templetJ_architecture>
			...
			<img class= "templetJ_archImg" src="/resources/img/portfolio/portfolioJ/forest1.png" alt="프로젝트 아키텍처">
		...
		<div class=templetJ_etc>
			<p class= templetJ_name>Related activity</p>
			<p class= templetJ_subtitle>프로젝트 관련 논문 및 저작권 등록</p>
			<h1 class= templetJ_title>관련활동</h1>
